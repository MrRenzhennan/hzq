        ...
        return {
            f: function (val, row) {
                if(row.customerKind == "1"){
                    return "<a href='customer/inhabitant_archiveinfo.html?" + row.ctmArchiveId + "'>" + '详情' + "</a> <a href='maintenance/modifyarchive.html?" + row.ctmArchiveId + "'>" + '修改' + "</a>";

                }else if(row.customerKind == "9"){
                    return "<a href='customer/inhabitant_nonarchiveinfo.html?" + row.ctmArchiveId + "'>" + '详情' + "</a> <a href='maintenance/non_modifyarchive.html?" + row.ctmArchiveId + "'>" + '修改' + "</a>";
                }
            }
        }
    }();
    ...
    return {
        ...
        reload: function () {
            ...
            var bd = {
                ...
                "wheres": "1=0 and ca.book_id = b.book_id  and ca.area_id in ("+loginarea.join()+") order by ca.customer_code",
                "page": true,
                "limit": 50
            };
            wx = XWATable.init(
