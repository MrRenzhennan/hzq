...
var inhabitnatArchiveManagementAction = function () {
    ...
    var archiveIdFormat = function () {
        return {
            f: function (val, row) {
                return "<a href='customer/inhabitant_archiveinfo.html?" + row.ctmArchiveId + "'>" + '详情' + "</a> <a href='customer/modify_inhabitant.html?" + row.ctmArchiveId + "'>" + '修改' + "</a>";
            }
        }
    }();
        ...
        reload: function () {
            ...
            var bd = {
                ...
                "froms": "gas_ctm_archive ca inner join gas_mrd_book b on b.book_id = ca.book_id ",
                 "wheres": "ca.book_id = b.book_id and ca.customer_kind = '1' and ca.area_id in ("+loginarea.join()+")",
                "page": true,
                "limit": 50
            };
            ...
            xw = XWATable.init(
                {
                    ...
                    findFilter: function () {
                        ...
                        bd = {
                            "cols": "ca.*,b.countper_id,b.serviceper_id"
                            , "froms": "gas_ctm_archive ca inner join gas_mrd_book b on b.book_id = ca.book_id "
                            , "wheres": whereinfo + " ca.book_id = b.book_id and ca.customer_kind = '1' and ca.area_id in ("+loginarea.join()+")",
                            "page": true,
                            "limit": 50
                        };
