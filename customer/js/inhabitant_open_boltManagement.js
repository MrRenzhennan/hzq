...
var Open_BoltAction = function () {
    ...
    var detailedInfoFormat = function () {
        return {
            f: function (val) {
                return '<a id="todetail" href="customer/inhabitant_open_bolt_detail.html?refno=' + val + '">详情</a>';
            }
        }
    }();
    return {
            ...
            xw = XWATable.init(
                {
                    ...
                    findFilter: function () {
                        ...
                        var filter = RQLBuilder.and([
                            find_area, find_projectNo,find_unboltNo, find_projectName, find_linkMan, find_buildUnit, find_projectAddress,customerType
                        ]);
...
function add() {
    window.location.href = "customer/inhabitant_open_bolt_input.html";
}