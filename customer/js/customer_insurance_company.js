...
//});
var CustomerInsuranceCompanyAction = function () {
            ...
            this.xw = XWATable.init(
                {
                    ...
                    restbase:'gasctminsurancecompany',
                    key_column:'insuranceCompanyId',
                    coldefs:[
                        {
...
//                      }
                    ...
                    findFilter: function(){//find function
                        var find_companyCode,find_companyName,find_status ;

						if($('#find_companyCode').val()){
							find_companyCode = RQLBuilder.equal("companyCode",$('#find_companyCode').val());
						}
						if($('#find_companyName').val()){
							find_companyName = RQLBuilder.like("companyName",$('#find_companyName').val());
						}
						if($('#find_status').val()){
							find_status = RQLBuilder.equal('status',$('#find_status').val());
						}
                        var filter = RQLBuilder.and([
                            find_companyCode,find_companyName,find_status
                        ]);
                        return filter.rql();
                    },//--findFilter
