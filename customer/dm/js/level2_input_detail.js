        ...
        success: function (data) {
            for (var i = 0; i < data.length; i++) {
                ...
                var bd = {
                    "cols": "count(*) as num",
                    "froms": "gas_mtr_meter",
                    "wheres": "reserved_field1='" + data[i].applyDetailId + "'",
                    "page": false
                };
...
$('#scanning_writeMod').on('show.bs.modal', function (e) {
    ...
    console.log(sy);
    console.log("applyDetailId"+applyDetailId);
    $.ajax({
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
    ...
    $('#saveId').click(function () {
        ...
        //     "cols": "count(*) as num",
        //     "froms": "gas_mtr_meter",
        //     "wheres": "reserved_field1='" + applyDetailId + "'",
        //     "page": false
        // };
        // console.log(JSON.stringify(bd));
        // $.ajax({
...
//     var stockHistory = new Array();
//     for (var i = 0; i < meterInfoId.length; i++) {
//         stockState.push({"stockState": "1", "meterId": meterInfoId[i], "depositoryId": targetDepositoryId});
//         stockHistory.push({
//             "meterId": meterInfoId[i],
//             "stockStatus": "1",
//             "lastStockStatus": "1",
...
//             success: function (e) {
//                 if (e.success == true) {
//                     meterInfoId.length = 0;
//                     meterNo.length=0;
//                     bootbox.alert("<br><center><h4>入库成功</h4></center><br>");
//                     location.reload();
//                 }
//             }
//         })
