...
$('#out_level1').click(function () {
    window.location.href = "customer/dm/out_in_apply.html?" + 1;
});
$('#out_level2').click(function () {
    window.location.href = "customer/dm/out_in_apply.html?" + 2;
});
...
$('#scanning_in_depository').click(function () {
    // var depository = $('#depositoryName').val();
    // if (depository) {
    window.location.href = "customer/dm/level2_input.html";
    // } else {
    //     bootbox.alert("<br><center><h4>请先选择一个入库仓库！</h4></center><br>");
    // }
});
$('#scanning_out_depository').click(function () {
    // var depository = $('#depositoryName').val();
    // if (depository) {
    window.location.href = "customer/dm/level2_out.html";
    // } else {
    //     bootbox.alert("<br><center><h4>请先选择一个出库仓库！</h4></center><br>");
    // }
});
//厂家级联
var factory;
    ...
    return {
        ...
        reload: function () {
            ...
            var bd = {
                "cols": "*",
                "froms": "gas_mtr_meter",
                "wheres": "depository_id in (select depository_id from gas_mtr_depository where func_level='2' and stock_state in('1','3') and area_id in(" + areas + "))",
                "page": true,
                "limit": 50
            };
            xw = XWATable.init(
                {
                    ...
                    findFilter: function () {
                        ...
                        bd = {
                            "cols": "*",
                            "froms": "gas_mtr_meter",
                            "wheres": whereinfo + "depository_id in (select depository_id from gas_mtr_depository where func_level='2' and stock_state in('1','3') and area_id in(" + areas + "))",
                            "page": true,
                            "limit": 50
                        };
                        console.log(bd);
