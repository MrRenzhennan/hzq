...
var meterExchangePlanAction = function () {
    ...
    var operateFormat = function () {
        return {
            f : function (val,row) {
                return "" +
                    "<a href='customer/dm/add_meter_exchange_plan_branch.html?planId="+ val + "&areaId="+row.areaId+"'>&nbsp;录入明细&nbsp;</a>" +
                    "<a href='customer/dm/meter_exchange_plan_detail.html?"+ val + "'>&nbsp;查看明细&nbsp;</a>";
            }
        }
    }();
    return {
             ...
             xw = XWATable.init(
                {
                    ...
                    checkAllToggle:true,
                    //----------------基本restful地址---
                    restbase: 'gasmtrplan?query={"plantype":"0203"}',
                    ...
                    findFilter: function(){//find function
                        ...
                        var plantype = RQLBuilder.equal('plantype','0203');
