    ...
    return {
        ...
        reload : function(){
            ...
            var bd={
                ...
                "froms":"(select * from  psm_step_inst d where d.gs_ecode='PFIVE' and d.flow_def_id ='CHANGEJP' and d.results='0') t " +
            ...
            xw = XWATable.init(
                {
                    ...
                    findFilter : function(){
                        ...
                        bd={
                            ...
                            "left join gas_csr_busi_register a on a.flow_instance = t.flow_inst_id left join gas_ctm_archive b on b.customer_code = a.customer_code " +
                            "left join gas_mrd_book c on c.book_id=b.book_id",
                            "wheres":sql + " order by a.accept_date desc,a.finish_date desc",
                            "page":true,
                            "limit":50
                        }
