        ...
        getTask:function(){ 
            $.ajax({
                ...
                success:function(data, textStatus, xhr) {
                    ...
                    if(obret.customerKind && obret.customerKind == '9'){
                        $('#customerKind').val("非居民");
                    }else if(obret.customerKind && obret.customerKind == '1'){
                        $('#customerKind').val("居民");
                    }
                    ...
                    $('#con').html(obret.con);
                    //---
                    $('#bookingtime').val(obret.bookingtime);
                    $('#changem').val(obret.param.changem).trigger("change");
                    $('#oldgt').val(gasTypeHelper.getDisplay(obret.oldgt));
                    $('#newgt').val(gasTypeHelper.getDisplay(obret.newgt));
