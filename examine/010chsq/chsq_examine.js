...
var CHSQAction = function() {
    return {
        ...
        agree:function(){ 
            CHSQAction.postSubmit("0");
            
        },
        unagree:function(encrypted){ 
            
            CHSQAction.postSubmit("1");
        ...
        getTask:function(){ 
            $.ajax({
                ...
                success:function(data, textStatus, xhr) {
                    ...
                    $('#strandReason').val(obret.strandReason);
                    $('#customerCodeAfter').val(obret.customerCodeAfter);
