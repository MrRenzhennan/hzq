/**
 * Created by anne on 2017/6/18.
 */


var ICCardCorrectAction= function () {
    //用户helper
    ...
    return {
        ...
        initHelper:function(){
            ...
            var data={"表具损坏":"表具损坏","重新开栓":"重新开栓","换表下线":"换表下线","预估气量过高":"预估气量过高"}
            ...
            bootbox.confirm("确定撤销吗?", function (result) {
                if (result == false) {
                    ...
                    if(status == '4'){
                        ...
                        var up = Restful.update(hzq_rest+"psmflowinst", correctFlowId, {
                            "flowStatus":"9"
                        })
