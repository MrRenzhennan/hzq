...
$('#cancel').click(function () {
    window.location = "charging/add_garbage_price.html";
});

var gasType1DataLength = 0;
var gasType2DataLength = 0;

var addGarbagePrice = function () {
    return {
                    ...
                    .done(function(data) {
                        if(data.success){
                            bootbox.alert("<br><center><h4>添加成功!!</h4></center><br>", function () {
                                window.location = "charging/garbagecost.html";
                            });
